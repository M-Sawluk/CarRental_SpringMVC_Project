...
public class UserController {
	...
	public String updateUser(@ModelAttribute("newUserF") @Valid FormUser newUserF, BindingResult result,
			@ModelAttribute("newEmail") @Valid Email newEmail, BindingResult result1, Model model,
